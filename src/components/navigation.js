...
function Navigation(props) {
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <NavLink to="/about"><a class="nav-link" style={navStyle}>About Me</a></NavLink>
        ...
        {/* <a class="nav-link" href="https://github.com/phill-star?tab=repositories">GitHub</a>
        <a class="nav-link" href="https://www.linkedin.com/in/mohamed-hussein-569aa828a/>LinkedIn</a> */}
